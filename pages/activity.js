...
window.resultView = new Vue({
  ...
  data: {
    allTasks: [
      ...
      //
      { description: "Do Leg Workout at IM Building", location: "ChIJ06khDUOuPIgRpSjRFPKPV-Y", points: 5 },
      { description: "Do Chest Workout at IM Building", location: "ChIJ06khDUOuPIgRpSjRFPKPV-Y", points: 5 },
      { description: "Do Back Workout at IM Building", location: "ChIJ06khDUOuPIgRpSjRFPKPV-Y", points: 5 },
      { description: "Run on the field near IM Building", location: "ChIJ06khDUOuPIgRpSjRFPKPV-Y", points: 5 },
      { description: "Play Basketball at IM Building", location: "ChIJ06khDUOuPIgRpSjRFPKPV-Y", points: 5 },
      //
      ...
      { description: "Go Vist Michigan Stadium", location: "ChIJTd-grjOuPIgRrdNQzLYIANc", points: 5 },
      { description: "Go Vist the Museum of Natural History", location: "ChIJhy11v0OuPIgR33uMs6yLATo", points: 5 },
      //
      { description: "Go Vist the Museum of Art", location: "ChIJbbmqg0euPIgRzlnhZSj2z8g", points: 5 },
